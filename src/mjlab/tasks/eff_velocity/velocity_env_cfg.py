...
This module provides the shared mjlab velocity design with a joint-effort action.
Robot-specific configurations provide motor models and residual torque parameters.
"""
...
def make_eff_velocity_env_cfg() -> ManagerBasedRlEnvCfg:
  """Create the base effort-controlled velocity tracking configuration."""
